...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__settings_settings__ = __webpack_require__(273);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_2__settings_settings__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_user__ = __webpack_require__(355);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_app_constant__ = __webpack_require__(120);
...
var Api = /** @class */ (function () {
    function Api(http) {
        this.http = http;
        this.url = __WEBPACK_IMPORTED_MODULE_2__app_app_constant__["a" /* ENV */].parseServerUrl;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_item__ = __webpack_require__(354);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Tab1Root = 'RentalsPage';
var Tab2Root = 'LaundryPage';
var Tab3Root = 'StudioPage';
//# sourceMappingURL=index.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_parse__ = __webpack_require__(215);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_parse___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_parse__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_app_constant__ = __webpack_require__(120);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthProvider = /** @class */ (function () {
    function AuthProvider() {
        this.parseAppId = __WEBPACK_IMPORTED_MODULE_4__app_app_constant__["a" /* ENV */].parseAppId;
        this.parseServerUrl = __WEBPACK_IMPORTED_MODULE_4__app_app_constant__["a" /* ENV */].parseServerUrl;
        this.parseInitialize();
        console.log('Initiated Auth');
    }
    AuthProvider.prototype.signin = function (username, password) {
        return new __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"](function (observer) {
            __WEBPACK_IMPORTED_MODULE_3_parse__["Parse"].User.logIn(username, password).then(function (user) {
                console.log(user);
                observer.next(true);
                observer.complete();
    ...
    AuthProvider.prototype.signup = function (account) {
        return new __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"](function (observer) {
            var user = new __WEBPACK_IMPORTED_MODULE_3_parse__["Parse"].User();
    ...
    AuthProvider.prototype.signout = function () {
        return new __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"](function (observer) {
            __WEBPACK_IMPORTED_MODULE_3_parse__["Parse"].User.logOut().then(function () { return observer.next(true); });
        });
    };
    AuthProvider.prototype.currentUser = function () {
        var u = __WEBPACK_IMPORTED_MODULE_3_parse__["Parse"].User.current();
        if (u) {
            var user = new User();
            user.id = u.id;
    ...
    AuthProvider.prototype.parseInitialize = function () {
        __WEBPACK_IMPORTED_MODULE_3_parse__["Parse"].initialize(this.parseAppId);
        __WEBPACK_IMPORTED_MODULE_3_parse__["Parse"].serverURL = this.parseServerUrl;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_parse__ = __webpack_require__(215);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_parse___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_parse__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_app_constant__ = __webpack_require__(120);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ParseProvider = /** @class */ (function () {
    function ParseProvider() {
        this.parseAppId = __WEBPACK_IMPORTED_MODULE_3__app_app_constant__["a" /* ENV */].parseAppId;
        this.parseServerUrl = __WEBPACK_IMPORTED_MODULE_3__app_app_constant__["a" /* ENV */].parseServerUrl;
        this.parseInitialize();
        console.log('Initiated Parse');
    }
    ParseProvider.prototype.getRentalProperties = function (offset, limit) {
        if (offset === void 0) { offset = 0; }
        if (limit === void 0) { limit = 3; }
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                var currentUser = __WEBPACK_IMPORTED_MODULE_2_parse__["Parse"].User.current();
                console.log(currentUser);
                var RentalProperty = __WEBPACK_IMPORTED_MODULE_2_parse__["Parse"].Object.extend('RentalProperties');
                //const RentalProperty = currentUser.relation('RentalProperties');
                var query = new __WEBPACK_IMPORTED_MODULE_2_parse__["Parse"].Query(RentalProperty);
                query.skip(offset);
                query.limit(limit);
                query.ascending("price");
                query.equalTo('isListed', true);
                query.find().then(function (Properties) {
                    resolve(Properties);
                }, function (error) {
                    reject(error);
                });
    ...
    ParseProvider.prototype.getRentalProperty = function (propertyId) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                var RentalProperty = __WEBPACK_IMPORTED_MODULE_2_parse__["Parse"].Object.extend('RentalProperties');
                var query = new __WEBPACK_IMPORTED_MODULE_2_parse__["Parse"].Query(RentalProperty);
                query.get(propertyId).then(function (Property) {
                    resolve(Property);
                }, function (error) {
                    reject(error);
                });
    ...
    ParseProvider.prototype.addRentalProperty = function (newProperty) {
        var RentalProperty = __WEBPACK_IMPORTED_MODULE_2_parse__["Parse"].Object.extend('RentalProperties');
    ...
    ParseProvider.prototype.parseInitialize = function () {
        __WEBPACK_IMPORTED_MODULE_2_parse__["Parse"].initialize(this.parseAppId);
...
var Settings = /** @class */ (function () {
    function Settings(storage, defaults) {
        ...
        this.SETTINGS_KEY = 'Borracho_settings';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_push__ = __webpack_require__(163);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ngx_translate_core__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ngx_translate_http_loader__ = __webpack_require__(330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_ionic_angular__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_parse_parse__ = __webpack_require__(271);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_auth_auth__ = __webpack_require__(270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__mocks_providers_items__ = __webpack_require__(214);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__providers__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__app_component__ = __webpack_require__(396);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_10_ionic_angular__["e" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_15__app_component__["a" /* MyApp */], {}, {
                    links: [
                        ...
                        { loadChildren: '../pages/chat-detail/chat-detail.module#ChatDetailPageModule', name: 'ChatDetailPage', segment: 'chat/:id', priority: 'low', defaultHistory: [] },
                        ...
                        { loadChildren: '../pages/laundry/laundry.module#LaundryPageModule', name: 'LaundryPage', segment: 'laundry', priority: 'low', defaultHistory: [] },
                        ...
                        { loadChildren: '../pages/rental-detail/rental-detail.module#RentalDetailPageModule', name: 'RentalDetailPage', segment: 'rental/:id', priority: 'low', defaultHistory: [] },
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__providers_parse_parse__["a" /* ParseProvider */],
                ...
                { provide: __WEBPACK_IMPORTED_MODULE_1__angular_core__["u" /* ErrorHandler */], useClass: __WEBPACK_IMPORTED_MODULE_10_ionic_angular__["d" /* IonicErrorHandler */] }
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_add_operator_toPromise__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_add_operator_toPromise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_rxjs_add_operator_toPromise__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_api__ = __webpack_require__(213);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var User = /** @class */ (function () {
    ...
    User.prototype.login = function (accountInfo) {
        var _this = this;
        var seq = this.api.post('login', accountInfo, { "headers": this.headers }).share();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__capacitor_core__ = __webpack_require__(397);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_angular__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_push__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers__ = __webpack_require__(148);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    function MyApp(translate, platform, settings, config, statusBar, push) {
        var _this = this;
        ...
        platform.ready().then(function () {
            ...
            SplashScreen.hide().catch(function (err) { console.log(err); });
            //this.initPush();
        });
        this.initTranslate();
    }
